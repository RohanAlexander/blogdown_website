...
After I compared the values that I created with the dataset that the Grattan Institute published I came up with an explanation for the issue. I think that in their Excel dataset the Grattan Institute ordered the columns for the SA3 areas and the incomes data separately instead of as a pair.
