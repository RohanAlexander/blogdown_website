...
Comparing just the values that I recreated with the values that the Grattan Institute published, it looks like in their Excel dataset they have ordered the columns for the SA3 areas and the incomes data separately instead of as a pair.
