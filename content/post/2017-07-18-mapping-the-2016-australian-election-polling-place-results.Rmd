...
The map of all this data is below and the note that follows details the process of downloading and merging first-preference votes by polling place, and then plotting it on an interactive map.
