...
National accounts go back to 1972 on ABS website
http://www.abs.gov.au/AUSSTATS/abs@.nsf/second+level+view?ReadForm&prodno=5206.0&viewtitle=Australian%20National%20Accounts:%20National%20Income,%20Expenditure%20and%20Product~Mar%202017~Latest~07/06/2017&&tabname=Past%20Future%20Issues&prodno=5206.0&issue=Mar%202017&num=&view=&

Input output tables go back to 1958–59
http://www.abs.gov.au/ausstats/abs@.nsf/PrimaryMainFeatures/5209.0.55.001?OpenDocument


Whole bunch of data at the RBA: 'Australian Economic Statistics 1949-1950 to 1996-1997'
http://www.rba.gov.au/statistics/frequency/occ-paper-8.html

N . G. Butlin 'Australian Domestic Product, Investment and Foreign Borrowing 1861 - 1938/39' 1962.
...
Graph: Records are available for X days per year.
Speakers: Total number of uniques speakers, (cummulative over time?).
Topics: Total number of topics as identified by Titles.
...
'Customs and excise duties were to become almost the federal government's sole revnue source for the first 10 years of Federation, and a major source in the years leading to World War 2. They were the subject of intense debate in teh parliament.' @Wilson2015 [p. 333]. Is this true? Etc etc, there's other claims about debate on this page.

### Topic analysis
Separate Question Time from the rest.
